export default {
  ...
  'form.basic-form.building.label': 'Building',
  'form.basic-form.building.placeholder': 'Building name, e.g. ZhiHua Building',
  'form.basic-form.building.required': 'Please enter the building name',
  'form.basic-form.floor.label': 'floor',
  'form.basic-form.floor.placeholder': 'e.g. 12',
  'form.basic-form.floor.required': 'Please enter the floor number',
  'form.basic-form.room.label': 'RoomName',
  'form.basic-form.room.placeholder': 'room name, e.g. JA102',
  'form.basic-form.room.required': 'Please enter the room name',
  'form.basic-form.row-count.label': 'Row count',
  'form.basic-form.row-count.placeholder': 'row count, e.g. 5',
  'form.basic-form.row-count.required': 'Please enter the row count',
  'form.basic-form.col-count.label': 'Col count',
  'form.basic-form.col-count.placeholder': 'Col count, e.g. 5',
  'form.basic-form.col-count.required': 'Please enter the col count',
